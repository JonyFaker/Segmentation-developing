...
class TimeCounter():
    ...
    def end(flag=True):
        ...
        if flag:
            print('iter {}, time_used: {}'
              .format(self.count, time_used))
        self.total_time = self.total_time + time_used

    def average():
        self.average = total_time / count
        print('totla_iter {}, average_time_used: {}'
              .format(self.count, average_time))
