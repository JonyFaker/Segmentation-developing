...
def checkpoint(nets, history, args, epoch_num):
    ...
    # origin is to save dict_encoder and dict_decoder
    torch.save(history,
...
def main(args):
    ...
    # class_weight = np.array([3.413913 , 8.055098 , 9.897862 , 9.581961 , 6.151737 , 4.312839 ,
    #                 9.07799  , 7.0774126, 8.1582365, 9.271245 , 7.6433125, 7.449705 ,
    #                 6.2268925, 3.7723124], dtype=np.float32)
    # class_weight = torch.from_numpy(class_weight)
    # crit = nn.NLLLoss(weight=class_weight, ignore_index=-1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgMaxSize', default=800, type=int,
